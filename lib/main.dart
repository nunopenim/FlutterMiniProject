...
class _AppScreenState extends State<AppScreen> {
  ...
  void demoMaker() {
    Incidente i1 = Incidente("Buraco", "Buraco na estrada no cruzamento da Rua das Flores com a Rua das Frutas. Cruzamento muito movimentado!", "", DateTime.now());
    gestorIncidentes.addIncidente(i1);
    Incidente i2 = Incidente("Esgoto", "Esgoto entupido na casa do Sr. José, causa possivel é má construção do edificio. Cano possivelmente furado", "Rua das Flores, nº25", DateTime.now());
              ...
              onTap: () {
                Navigator.push(context,
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content:
                          Text("O seu incidente foi submetido com sucesso.")));
                });
              },
            ),
            ListTile(
        ...
        builder: (BuildContext context, snapshot) => ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Dismissible(
                ...
                child: ListTile(
                  title: Text(incidente.titulo + "\n" + incidente.data.toString().split(".")[0], textScaleFactor: 0.9),
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => Detalhe(incidente: incidente)));
                  },
